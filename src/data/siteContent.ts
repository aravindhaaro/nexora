...
export const siteContent = {
  ...
  about: {
    ...
    clients: [
      { name: "Apple", logo: new URL("../assets/clients/apple.svg", import.meta.url).href },
      { name: "Google", logo: new URL("../assets/clients/google.svg", import.meta.url).href },
      { name: "Spotify", logo: new URL("../assets/clients/spotify.svg", import.meta.url).href },
      { name: "Nike", logo: new URL("../assets/clients/nike.svg", import.meta.url).href },
      { name: "Airbnb", logo: new URL("../assets/clients/airbnb.svg", import.meta.url).href },
      { name: "Stripe", logo: new URL("../assets/clients/stripe.svg", import.meta.url).href },
      { name: "Notion", logo: new URL("../assets/clients/notion.svg", import.meta.url).href },
      { name: "Figma", logo: new URL("../assets/clients/figma.svg", import.meta.url).href },
      { name: "Linear", logo: new URL("../assets/clients/linear.svg", import.meta.url).href },
      { name: "Vercel", logo: new URL("../assets/clients/vercel.svg", import.meta.url).href },
      { name: "Pitch", logo: new URL("../assets/clients/pitch.svg", import.meta.url).href },
      { name: "Framer", logo: new URL("../assets/clients/framer.svg", import.meta.url).href },
    ],
  },
  cinematic: {
    scenes: [
